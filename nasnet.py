...
class NASNetALarge(nn.Module):
    ...
    def features(self, input):
        ...
        x_stem_0 = self.cell_stem_0(x_conv0)  # 168x128x128
        x_stem_1 = self.cell_stem_1(x_conv0, x_stem_0)  # 336x64x64

        x_cell_0 = self.cell_0(x_stem_1, x_stem_0)  # 1008x64x64
        x_cell_1 = self.cell_1(x_cell_0, x_stem_1)
        x_cell_2 = self.cell_2(x_cell_1, x_cell_0)
        x_cell_3 = self.cell_3(x_cell_2, x_cell_1)
        x_cell_4 = self.cell_4(x_cell_3, x_cell_2)
        x_cell_5 = self.cell_5(x_cell_4, x_cell_3)  # 1008x64x64

        x_reduction_cell_0 = self.reduction_cell_0(x_cell_5, x_cell_4)  # 1344x32x32
        ...
        x_cell_11 = self.cell_11(x_cell_10, x_cell_9)  # 2016x32x32

        x_reduction_cell_1 = self.reduction_cell_1(x_cell_11, x_cell_10)  # 2688x16x16
        ...
        x_cell_17 = self.cell_17(x_cell_16, x_cell_15)  # 4032x16x16
        return x_cell_17
...
def nasnetalarge(num_classes=1000, pretrained='imagenet'):
    ...
    if pretrained:
        ...
        # model.load_state_dict(model_zoo.load_url(settings['url'])) ## 加载网络
        model.load_state_dict(torch.load('../pth/nasnetalarge.pth'), strict=False)
